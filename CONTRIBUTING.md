...
tests/fm-classify-lib.test.sh             # shared status classifier: native-Windows UTF-8 BOM normalization, proven UTF-16 status decoding, captain-relevant matching, and POSIX byte identity
