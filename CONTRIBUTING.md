...
tests/fm-classify-lib.test.sh             # shared status classifier: UTF-8 BOM normalization, captain-relevant matching, and POSIX no-BOM byte identity
