...
tests/fm-classify-lib.test.sh             # shared status classifier: UTF-8 BOM normalization, proven UTF-16 status decoding, captain-relevant matching, and POSIX no-BOM byte identity
