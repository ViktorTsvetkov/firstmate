...
tests/fm-backend-herdr-release.test.sh    # focused fake-herdr regression for native-Windows empty-session release after the last pane closes, including non-empty-session and POSIX no-op guards
