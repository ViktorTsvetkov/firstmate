...
This is now zellij-specific; the herdr adapter moved to native agent-state submit confirmation with an ANSI-aware composer fallback after the 2026-07-03 grok slash-submit incident described in `docs/herdr-backend.md`.
