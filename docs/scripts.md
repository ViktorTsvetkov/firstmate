...
| `fm-bootstrap.sh`        | Detect toolchain and fleet problems, run the locked session-start sweeps, install approved tools, and strip Windows CR from active dispatch-profile output |
