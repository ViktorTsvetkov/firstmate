...
case "$(uname -s)" in
  MINGW*|MSYS*|CYGWIN*) echo "skip: WINDOWS-DEFER fm-backend-herdr-prune-safety-e2e - real-herdr e2e fails and leaks herdr processes on Windows substrate (winport Phase 2 (herdr backend))"; exit 0 ;;
esac
